...
import ru.app.apteka.databinding.CardOrderItemBinding
import ru.app.apteka.models.Product

class OrderItemAdapter() : RecyclerView.Adapter<OrderItemAdapter.ViewHolder>() {

    inner class ViewHolder(val binding: CardOrderItemBinding) : RecyclerView.ViewHolder(binding.root) {
